odoo.define('asset_management_deprecaition.widget', function(require) {
"use strict";
 ...
 * create_move on the object asset.management.depreciation.
 * Note that this widget can only work on the asset.management.depreciation
...
var AssetManagementDepreciationWidget = AbstractField.extend({
...
registry.add("dep_lines_toggler", AssetManagementDepreciationWidget);
